...
public class Menu2_1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Menu2_1Activity.this, "stop clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rl_hammer.getVisibility() == View.VISIBLE) {
                    ...
                    startActivity(new Intent(Menu2_1Activity.this, Menu2Activity.class));
                    finish();
                }
            }
        });
        ...
        imgHammer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Menu2_1Activity.this, "click", Toast.LENGTH_SHORT).show();
            }
        });
    }
